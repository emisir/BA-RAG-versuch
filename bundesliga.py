...
for filename in os.listdir(data_dir):
    ...
    if filename.endswith(".csv") and "1-bundesliga" in filename.lower():
...
# Initialisieren der Query Engine mit dem kombinierten DataFrame
bundesliga_query_engine = PandasQueryEngine(df=all_stats_df, verbose=True, instruction_str=instruction_str)
bundesliga_query_engine.update_prompts({"pandas_prompt": new_prompt})