...
for filename in os.listdir(data_dir):
    ...
    if filename.endswith(".csv") and "3-liga" in filename.lower():
...
thirdLiga_query_engine = PandasQueryEngine(df=all_stats_df, verbose=True, instruction_str=instruction_str)
thirdLiga_query_engine.update_prompts({"pandas_prompt": new_prompt})